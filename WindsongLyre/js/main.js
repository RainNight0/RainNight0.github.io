...
var $openInfoScreen = document.getElementById("open_info_screen");
if ($openInfoScreen) {
	$openInfoScreen.addEventListener("click", function () {
		document.getElementById("info_screen_box").style.display = "block";
	});
}
var $openInfoScreen = document.getElementById("exit_info_screen");
if ($openInfoScreen) {
	$openInfoScreen.addEventListener("click", function () {
		document.getElementById("info_screen_box").style.display = "none";
	});
}
